...
#ifndef OMNIVERSE_SWIFT_H
#define OMNIVERSE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Omniverse",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class UIWindow;
SWIFT_CLASS("_TtC9Omniverse11AppDelegate")
...
/// (<code>badCertificateCallback => true</code>) so scraper/stream hosts with self-signed
/// or mismatched certs still resolve.
SWIFT_CLASS("_TtC9Omniverse4Http")
...
SWIFT_CLASS("_TtC9Omniverse20PermissiveAssetTrust")
@interface PermissiveAssetTrust : NSObject <AVAssetResourceLoaderDelegate>
- (BOOL)resourceLoader:(AVAssetResourceLoader * _Nonnull)resourceLoader shouldWaitForResponseToAuthenticationChallenge:(NSURLAuthenticationChallenge * _Nonnull)authenticationChallenge SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
